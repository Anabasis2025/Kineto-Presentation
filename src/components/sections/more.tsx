    ...
    <ScrollSection id="demo" className="bg-zinc-900">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="glass rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
          ...
          <a href="https://huggingface.co/spaces/your-space-here" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl font-semibold text-lg hover:from-indigo-500 hover:to-purple-500 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="https://github.com/Anabasis2025/Kineto" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 glass rounded-lg hover:bg-zinc-800 transition-colors">
            ...
            <a href="https://huggingface.co/spaces/your-space" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg hover:from-indigo-500 hover:to-purple-500 transition-all">
